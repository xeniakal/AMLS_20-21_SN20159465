...
*P.S. To train by yourself the **final best performing model** just run the cell under the subsection <ins>Train from scratch the best performing model</ins> under the headline <ins>Best performing model</ins>.*
